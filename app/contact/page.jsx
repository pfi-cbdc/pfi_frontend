    ...
    <div className="relative min-h-screen overflow-hidden pb-5">
      ...
      <div className={`relative pt-24 p-1 flex justify-end items-center h-full transition-transform duration-1000 ease-out ${showContent ? 'translate-x-0' : 'translate-x-full'}`}>
        <div className="w-full mt-7 md:w-[40%] ml-auto">
          <div className="p-2 md:p-8 bg-black bg-opacity-50 rounded-lg">
            <h2 className="text-3xl font-bold mb-1 text-white">Contact us</h2>
            <p className="text-white mb-10">We will be in touch soon...</p>
